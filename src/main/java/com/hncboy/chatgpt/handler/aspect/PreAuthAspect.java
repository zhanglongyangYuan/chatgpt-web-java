package com.hncboy.chatgpt.handler.aspect;

import cn.hutool.core.util.BooleanUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.servlet.ServletUtil;
import com.hncboy.chatgpt.config.ChatConfig;
import com.hncboy.chatgpt.exception.AuthException;
...
public class PreAuthAspect {
    ...
    @Pointcut("@annotation(com.hncboy.chatgpt.annotation.PreAuth) || @within(com.hncboy.chatgpt.annotation.PreAuth)")
